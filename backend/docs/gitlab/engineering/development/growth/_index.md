...
For information about collaborating with the Fulfillment/Provision team on CustomersDot trials work, see our [CustomersDot Trials Collaboration Framework](customersdot-collaboration.md). This framework defines when Growth contributes independently versus when to engage the Provision team, along with escalation paths for priority conflicts.
