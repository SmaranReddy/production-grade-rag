...
The Provision team collaborates with the Growth team on CustomersDot trials work. Growth team focuses on trial-specific functionality (eligibility, duration, UX, tracking) while Provision maintains ownership of core provisioning, billing, and subscription infrastructure. For detailed collaboration guidelines, see the [Growth team's CustomersDot Trials Collaboration Framework](/handbook/engineering/development/growth/customersdot-collaboration/). When Growth engineers need to contribute to CustomersDot for trials work, they should follow the decision framework documented there. For questions or collaboration requests, reach out in [#s_fulfillment](https://gitlab.slack.com/channels/s_fulfillment) or [#s_growth](https://gitlab.slack.com/channels/s_growth) Slack channels.
...
- [Growth team CustomersDot collaboration framework](/handbook/engineering/development/growth/customersdot-collaboration/) - Decision framework for Growth-Provision collaboration on trials work
