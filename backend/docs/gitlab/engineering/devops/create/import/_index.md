...
Each milestone, two backend engineers in the team are assigned the role of Milestone Doctor, one as Primary and the other as Secondary. The assignments are in the [Milestone Doctor rotation schedule](https://gitlab.com/groups/gitlab-org/-/epics/19236#milestone-doctor---rotation-schedule). Engineers can freely trade upcoming shifts and update the schedule.
